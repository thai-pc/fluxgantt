...
- Performance budget is tested: bundle size (five gzip fixtures in `packages/core/size-limit/`, from `createGantt()`-only up to the fully-composed instance — see CLAUDE.md golden rule 5 for the table), rendering 1000+ tasks, Canvas switch ≥2000.
